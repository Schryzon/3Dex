...
This class diagram represents the complete data models, their structured UML relations including inheritance (generalization), composition, aggregation, and their respective domain functions/methods in the 3Dex application.
...
classDiagram
    ...
    Artist --|> User : inherits
    Provider --|> User : inherits
    Admin --|> User : inherits
    ...
    Model o-- Order_Item : referenced_in
    Model o-- Collection_Item : referenced_in
    Model o-- Review : has
    Model o-- Purchase : has
    Model o-- Wishlist : in_wishlist
    Model o-- Cart_Item : in_cart

    Artist "1" --> "*" Model : creates
    Customer "1" --> "*" Purchase : purchases
    Customer "1" --> "*" Order : places
    Provider "1" --> "*" Order : satisfies
    User "1" --> "*" User_Review : receives/gives
