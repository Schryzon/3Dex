    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 text-center pt-20">
        ...
        <div
          ...
          className="inline-flex flex-wrap items-center justify-center gap-2 mb-6 md:mb-8 text-white"
        >
        ...
        <h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 md:mb-6 leading-tight px-2"
        >
        ...
        <p
          ...
          className="text-lg sm:text-xl md:text-2xl text-white/90 mb-8 md:mb-12 max-w-4xl mx-auto leading-relaxed px-4"
        >
