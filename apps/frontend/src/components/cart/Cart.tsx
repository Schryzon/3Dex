...
export default function ShoppingCartPage() {
  ...
  const handlePayment = (method: 'credit' | 'paypal' | 'wallet') => {
            ...
            <div className="lg:col-span-2">
              ...
              {isCartEmpty && (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <Link
                    href="/models"
                    className="bg-yellow-400 hover:bg-yellow-300 text-black font-bold px-8 py-3 rounded-lg transition-colors"
                  >
                    Browse 3D Models
                  </Link>
                </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 sticky top-4">
                ...
                <button
                  ...
                  className="w-full bg-yellow-400 hover:bg-yellow-300 disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed text-black font-bold py-3 rounded-lg transition-colors mb-3"
                >
                  Pay
                </button>
                ...
                <button
                  ...
                  disabled={isCartEmpty}
                  className="w-full bg-white hover:bg-gray-100 disabled:bg-gray-700 disabled:cursor-not-allowed text-black py-3 rounded-lg transition-colors mb-3 flex items-center justify-center"
                >
                ...
                <button
                  ...
                  disabled={isCartEmpty}
                  className="w-full bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 disabled:text-gray-600 disabled:cursor-not-allowed text-white py-3 rounded-lg transition-colors mb-6"
                >
                  Pay with wallet
                </button>
                ...
                <div className="space-y-4 text-xs text-gray-400">
                  <p>
                    You may pay via credit card, PayPal or wallet. Rest assured, we use payment information solely for this transaction and do not store it.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <Link href="/terms" className="text-white hover:text-yellow-400 underline">
                      Terms of Use
                    </Link>
                    ,{' '}
                    <Link href="/privacy" className="text-white hover:text-yellow-400 underline">
                      Privacy Policy
                    </Link>
                    , and{' '}
                    <Link href="/payment-method" className="text-white hover:text-yellow-400 underline">
