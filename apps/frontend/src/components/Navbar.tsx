      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            <Link href="/cart" className="text-gray-300 hover:text-white relative cursor-pointer">
              <ShoppingCart className="w-6 h-6" />
            </Link>
            
            <button 
              onClick={onLoginClick}
              className="text-gray-300 hover:text-white px-4 py-2 cursor-pointer"
            >
              Login
            </button>
            ...
            <button 
              ...
              className="relative px-6 py-2 bg-white text-black rounded-full font-semibold hover:bg-gray-100 transition-colors cursor-pointer"
            >
              Register
