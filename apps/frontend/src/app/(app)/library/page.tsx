                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
                    ...
                    {activeTab === 'collections' && (
                        <button
                            ...
                            className="bg-white hover:bg-yellow-400 text-black px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-xl active:scale-95 flex items-center gap-2"
                        >
                    ...
                    <AnimatePresence mode="wait">
                        {isLoading ? (
                            ...
                            >
                                ...
                                <span className="text-[10px] font-black text-gray-600 uppercase tracking-[0.3em]">Synching Assets...</span>
                            </motion.div>
                            ...
                            >
                                ...
                                <Link href="/catalog" className="mt-8 inline-block px-10 py-4 bg-white hover:bg-yellow-400 text-black font-black uppercase tracking-widest text-[10px] rounded-2xl transition-all active:scale-95">
                                    Browse Marketplace
                                </Link>
                            </motion.div>
                        ) : (
            ...
            {isCreatingOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
                    ...
                    <div className="relative w-full max-w-md bg-[#111] border border-white/10 rounded-[2.5rem] p-8 shadow-2xl overflow-hidden">
                        ...
                        <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter mb-8">Create <span className="text-yellow-400">Folder</span></h2>
                        <input
                            autoFocus
                            type="text"
                        ...
                        <div className="flex gap-4">
                            <button onClick={() => setIsCreatingOpen(false)} className="flex-1 bg-white/5 hover:bg-white/10 text-gray-400 py-4 rounded-2xl font-bold uppercase tracking-widest text-[10px] transition-all">Cancel</button>
                            <button 
                                onClick={async () => {
                                ...
                                className="flex-1 bg-yellow-400 hover:bg-yellow-300 text-black py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all shadow-xl shadow-yellow-400/10"
                            >
                                Initialize
                            </button>
                        </div>
                    ...
                    <div className="w-full h-full flex gap-1.5 p-1.5">
                        ...
                        <div className="flex-1 flex flex-col gap-1.5">
                            ...
                            <div className="flex-1 rounded-xl bg-white/5 flex items-center justify-center">
                                <span className="text-[10px] font-black text-gray-600">+{Math.max(0, (item._count?.items ?? 0) - 2)}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="group relative bg-[#0c0c0c] rounded-[2rem] border border-white/5 hover:border-yellow-400/40 transition-all duration-500 overflow-hidden shadow-2xl">
            ...
            <div className="p-5">
                ...
                {type === 'purchases' && (
                   <div className="flex items-center gap-2 text-[9px] font-bold text-gray-700 uppercase italic">
                ...
                {type === 'uploads' && (
                   <div className="flex items-center justify-between">
                       ...
                       <Link href={`/catalog/${model.id}/edit`} className="text-[9px] font-black text-gray-500 hover:text-white transition-colors uppercase tracking-widest">Edit Mesh</Link>
                   </div>
                )}
            </div>
        </div>
