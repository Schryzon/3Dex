                            ...
                            <div className="space-y-3">
                                {addedLocally ? (
                                    <button
                                        ...
                                        className="w-full cursor-pointer bg-yellow-500 hover:bg-yellow-400 text-black py-3 px-4 rounded-lg font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-yellow-500/20 hover:scale-[1.02] active:scale-[0.98]"
                                    >
