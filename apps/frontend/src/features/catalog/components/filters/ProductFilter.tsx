          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <div className="relative w-full">
                <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-500 font-medium">{currency === 'idr' ? 'Rp' : '$'}</span>
                <input
                  type="number"
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded pl-7 pr-3 py-2 text-sm"
                  placeholder="Min"
                />
              </div>
